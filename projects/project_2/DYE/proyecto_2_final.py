...
# Definimos el dataframe de Jaccard
...
# Obtenemos las samples de 1% y 5%
...
for i in range(100): 
    # vamos a hacer el bootstrap con 5%
...
# %%
# Calculamos los confidence intervals
...
# %%
print(jaccard_df[jaccard_df['Jaccard(context_i_line_j, q_i_k)'] > 0.75].Ans.value_counts())
# %%
print(jaccard_df.Ans.value_counts())
